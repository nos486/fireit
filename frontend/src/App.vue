  ...
  <div class="min-h-screen bg-[#0a0b0f] text-slate-300">
      ...
      <div class="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            @click="fetchData"
            :disabled="loading"
            class="flex items-center gap-2 px-3 py-1.5  border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] hover:border-orange-500/30 transition-all duration-200 text-slate-400 hover:text-orange-400 disabled:opacity-40 disabled:cursor-not-allowed text-xs font-medium"
          >
    ...
    <main class="relative z-10 max-w-7xl mx-auto px-6 py-8 space-y-4">
      ...
      <Transition name="slide-down">
        <div v-if="error" class="flex items-center gap-3 p-4  bg-red-500/5 border border-red-500/20 text-red-400 text-sm">
