  ...
  <DetailCard title="Latency Test" icon='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>' :loading="false">
    <div class="space-y-1">
      ...
      <button
        @click="runTest"
        :disabled="running"
        class="w-full mt-auto py-2.5 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] border transition-all duration-300"
        :class="running
          ? 'border-white/5 bg-white/[0.02] text-slate-600 cursor-not-allowed'
          : 'border-orange-500/20 bg-orange-500/5 text-orange-400 hover:bg-orange-500/10 hover:border-orange-500/40 hover:shadow-[0_0_20px_rgba(249,115,22,0.1)]'"
      >
