...
<template>
  <DetailCard title="Privacy Leaks" icon='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>' :loading="false">
    <div class="space-y-6">
      ...
      <!-- DNS Section -->
      <div class="group/leak relative p-3 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-all duration-300 flex-1">
        <div class="flex items-center justify-between mb-3 border-b border-white/[0.05] pb-2">
          <div class="flex items-center gap-2">
      ...
      <button
        ...
        class="w-full mt-auto py-2.5 rounded-xl text-[10px] font-bold uppercase tracking-[0.2em] border border-orange-500/20 bg-orange-500/5 text-orange-400 hover:bg-orange-500/10 hover:border-orange-500/40 hover:shadow-[0_0_20px_rgba(249,115,22,0.1)] transition-all duration-300 disabled:opacity-30"
      >
